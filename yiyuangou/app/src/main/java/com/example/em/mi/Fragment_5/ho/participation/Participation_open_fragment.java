...
public class Participation_open_fragment extends Fragment{
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.participation_open_fragment, container, false);
        //初始化数据
        initDatas();
        //初始化组件
        initView();
    ...
    private void initView() {
        re = (RecyclerView)view.findViewById(R.id.participation_new_recyclerview);
